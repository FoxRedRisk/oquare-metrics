...
java -jar "$OQUARE_PATH" --ontology "./$ontology_files" --metrics "$contents_folder/temp_results/ontologies/imports/metrics.xml" -r "$reasoner" --output "$contents_folder/temp_results/ontologies/imports/metrics.xml"
